 ...
 */
export default () => (
  <board width="80mm" height="62mm" layers={4}>
    <net name="VBAT" />
    <net name="VIN" />
    <net name="V3V3" />
    <net name="GND" />
    ...
    <pinheader name="J1" pinCount={2} footprint="pinrow2" pitch="2.54mm"
      pcbX={-35} pcbY={20} schX={-16} schY={8} />
    ...
    <mosfet name="Q1" channelType="p" mosfetMode="enhancement" footprint="sot223"
      pcbX={-26} pcbY={20} schX={-13} schY={8} />
    <resistor name="R4" resistance="100k" footprint="0402" pcbX={-30} pcbY={14} schX={-13} schY={5} />

    {/* Bulk on the raw rail, sized for motor inrush */}
    <capacitor name="C1" capacitance="220uF" footprint="1206"
      maxDecouplingTraceLength="15mm" pcbX={-17} pcbY={20} schX={-11} schY={6} />
    ...
    <chip name="U1" footprint="sot223" manufacturerPartNumber="AMS1117-3.3"
      ...
      pcbX={-9} pcbY={20} schX={-8} schY={7} />

    <capacitor name="C2" capacitance="10uF" footprint="0805"
      maxDecouplingTraceLength="15mm" pcbX={-17} pcbY={15} schX={-10} schY={5} />
    <capacitor name="C3" capacitance="22uF" footprint="0805"
      maxDecouplingTraceLength="15mm" pcbX={-2} pcbY={20} schX={-5} schY={5} />
    ...
    <capacitor name="C4" capacitance="100nF" footprint="0402"
      maxDecouplingTraceLength="15mm" pcbX={0} pcbY={8.6} schX={5} schY={6} />
    <capacitor name="C5" capacitance="100nF" footprint="0402"
      maxDecouplingTraceLength="15mm" pcbX={7} pcbY={2} schX={7} schY={6} />
    <capacitor name="C6" capacitance="100nF" footprint="0402"
      maxDecouplingTraceLength="15mm" pcbX={0} pcbY={-4.6} schX={9} schY={6} />
    <capacitor name="C7" capacitance="10uF" footprint="0805"
      maxDecouplingTraceLength="15mm" pcbX={7} pcbY={-6} schX={3} schY={6} />

    {/* Analogue supply filter */}
    <capacitor name="C8" capacitance="100nF" footprint="0402"
      maxDecouplingTraceLength="15mm" pcbX={-7} pcbY={-2} schX={-3} schY={6} />

    {/* 8MHz crystal */}
    <crystal name="Y1" frequency="8MHz" loadCapacitance="20pF" footprint="0805" maxTraceLength="30mm"
      pcbX={-9} pcbY={2} schX={-6} schY={-2} />
    <capacitor name="C9" capacitance="22pF" footprint="0402" pcbX={-13} pcbY={4} schX={-8} schY={-1} />
    <capacitor name="C10" capacitance="22pF" footprint="0402" pcbX={-13} pcbY={0} schX={-8} schY={-3} />

    {/* Reset */}
    <pushbutton name="SW1" footprint="pushbutton" pcbX={-20} pcbY={9} schX={-12} schY={-4} />
    <resistor name="R1" resistance="10k" footprint="0402" pcbX={-26} pcbY={9} schX={-12} schY={-1} />

    {/* SWD programming header */}
    <pinheader name="J2" pinCount={4} footprint="pinrow4" pitch="2.54mm"
      pcbX={-30} pcbY={2} schX={-16} schY={-6} />
    ...
    <chip name="U3" footprint="qfn24" manufacturerPartNumber="MPU-6050"
      ...
      pinAttributes={{ VDD: { requiresPower: true }, GND_1: { requiresGround: true } }}
      pcbX={22} pcbY={12} schX={12} schY={2} />
    <capacitor name="C11" capacitance="100nF" footprint="0402"
      maxDecouplingTraceLength="15mm" pcbX={28} pcbY={12} schX={15} schY={3} />

    {/* GPS receiver module on a 4-pin header: VCC, GND, TX, RX */}
    <pinheader name="J3" pinCount={4} footprint="pinrow4" pitch="2.54mm"
      pcbX={34} pcbY={25} schX={16} schY={2} />
    ...
    <chip name="U4" footprint="tssop16" manufacturerPartNumber="DRV8833"
      ...
      pcbX={-16} pcbY={-13} schX={-8} schY={-10} />
    <capacitor name="C12" capacitance="10uF" footprint="0805"
      maxDecouplingTraceLength="15mm" pcbX={-16} pcbY={-7} schX={-11} schY={-9} />
    <capacitor name="C14" capacitance="10uF" footprint="0805"
      maxDecouplingTraceLength="15mm" pcbX={-22} pcbY={-13} schX={-11} schY={-12} />
    ...
    <pinheader name="J4" pinCount={2} footprint="pinrow2" pitch="2.54mm"
      pcbX={-30} pcbY={-20} schX={-14} schY={-14} />
    <pinheader name="J5" pinCount={2} footprint="pinrow2" pitch="2.54mm"
      pcbX={-14} pcbY={-22} schX={-10} schY={-14} />
    <pinheader name="J6" pinCount={2} footprint="pinrow2" pitch="2.54mm"
      pcbX={14} pcbY={-22} schX={10} schY={-14} />
    <pinheader name="J7" pinCount={2} footprint="pinrow2" pitch="2.54mm"
      pcbX={30} pcbY={-20} schX={14} schY={-14} />

    {/* ── Indicators ─────────────────────────────────────────────────────── */}

    <resistor name="R2" resistance="1k" footprint="0402" pcbX={26} pcbY={5} schX={13} schY={-4} />
    <led name="D2" color="green" footprint="0603" pcbX={30} pcbY={5} schX={13} schY={-6} />
    <resistor name="R3" resistance="1k" footprint="0402" pcbX={26} pcbY={0} schX={16} schY={-4} />
    <led name="D3" color="blue" footprint="0603" pcbX={30} pcbY={0} schX={16} schY={-6} />
