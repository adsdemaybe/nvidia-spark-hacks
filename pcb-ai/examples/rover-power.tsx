 ...
 */
export default () => (
  <board width="45mm" height="32mm" layers={2} minViaHoleDiameter="0.3mm" minViaPadDiameter="0.6mm">
    <net name="VIN" />
    <net name="VBAT" />
    <net name="GND" />
